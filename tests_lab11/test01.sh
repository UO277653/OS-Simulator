...
GOT=$( \
    ...
    --assertsFile=dummy \
    ./tests_lab11/test01.prog 1 \
    ./tests_lab11/test01.prog 2 \
    ./tests_lab11/test01.prog 4 \
    ./tests_lab11/test01.prog 150 \
    not_existing.prog 270 \
)
EXPECTED="./tests_lab11/test01.out"

echo "Test exercises of the V3"
echo "(Assuming you have up to exercise 4 (included) completed)"
