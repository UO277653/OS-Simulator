...
GOT=$( \
    ...
    --assertsFile=dummy \
    ./tests_lab09/test06_1.prog \
    ./tests_lab09/test06_2.prog \
    ./tests_lab09/test06_3.prog \
)
EXPECTED="./tests_lab09/test06.out"

echo "Test: Yield skip due to no more programs with same priority"
